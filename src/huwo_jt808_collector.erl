...
register(ClientId, Pid) ->
    gen_server:call(huwo_jt808_collector, {register, ClientId, Pid}, infinity).

unregister(ClientId, Pid) ->
    gen_server:call(huwo_jt808_collector, {unregister, ClientId, Pid}, infinity).

list() ->
    gen_server:call(huwo_jt808_collector, list).
